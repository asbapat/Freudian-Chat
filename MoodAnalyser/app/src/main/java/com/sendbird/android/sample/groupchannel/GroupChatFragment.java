...
import com.sendbird.android.sample.main.ApiFragment;
...
public class GroupChatFragment extends Fragment {
    ...
    private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            System.out.println("in mMessageSendButton userInput:" +userInput);

            if (userInput == null || userInput.length() <= 0) {
                return;
            }
//            mActivity.startAnalyze(userInput ,  getApiFragment());
            sendUserMessage(userInput);
            System.out.println("after user message");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMessageSendButton.setOnClickListener(mOnClickListener);
        GroupChatAdapter.getList();
...
//                    return;
//                }
//                System.out.println("in mMessageSendButton");
//                mActivity.startAnalyze();
//                sendUserMessage(userInput);
//                mMessageEditText.setText("");
//            }
//        });
    ...
    public List<HashMap<Long, String>> messages(){
        return GroupChatAdapter.getList();
    }
    ...
    public ApiFragment getApiFragment() {
        return (ApiFragment) getFragmentManager().findFragmentByTag(FRAGMENT_API);
    }
}
